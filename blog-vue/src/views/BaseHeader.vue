  ...
  <el-header class="me-area">
    <el-row class="me-header">
      ...
      <el-col v-if="!simple" :span="12">
        <el-menu :router=true menu-trigger="click" active-text-color="#1a1818" :default-active="activeIndex"
                 mode="horizontal">
      ...
      <el-col :span="6">
        <el-menu  mode="horizontal" active-text-color="#1a1818">
            <el-menu-item >
      ...
      <el-col :span="4">
        <el-menu :router=true menu-trigger="click" mode="horizontal" active-text-color="#1a1818">
