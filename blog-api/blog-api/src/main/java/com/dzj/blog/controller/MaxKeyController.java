...
public class MaxKeyController {
    ...
    public String login(){
        ...
        String url = "http://localhost:8080/maxkey/authz/oauth/v20/authorize?client_id=669240069155979264&response_type=code&redirect_uri=http://43.138.203.38:8888/maxKey/code";
        return "redirect:"+url;
    }
