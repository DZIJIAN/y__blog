...
public class ViewCountHandler {
    ...
    public void scheduled(){
        log.info("=====>>>>> 同步浏览和评论开始执行  {}",new DateTime().toString("yyyy-MM-dd HH:mm:ss"));
        ...
        log.info("=====>>>>> 同步浏览和评论结束  {}",new DateTime().toString("yyyy-MM-dd HH:mm:ss"));
    }
